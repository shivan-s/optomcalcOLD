...
from .views import (
    ...
    CTCalculate,
    MeanOcularPerfusionPressureView,
    MOPPCalculate,
)
...
urlpatterns = [
    ...
    path(
        "minimum_blank_size/", MinimumBlankSizeView.as_view(), name="minimum_blank_size"
    ),
    ...
    path(
        "cylinder_transpose/", CylinderTranposeView.as_view(), name="cylinder_transpose"
    ),
    path("ct_calculate/", CTCalculate.as_view(), name="ct_calculate"),
    path(
        "mean_ocular_perfusion_pressure/",
        MeanOcularPerfusionPressureView.as_view(),
        name="mean_ocular_perfusion_pressure",
    ),
