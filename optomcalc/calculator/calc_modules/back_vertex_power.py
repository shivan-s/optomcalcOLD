...
class BVPCalculate(View):
    def post(self, request):
        ...
        if (
            not ref["original_bvd"]
            or not ref["new_bvd"]
            and (not right_entered or not left_entered)
        ):
            ...
            def _calculate_vertex_power(
                sphere: float, cylinder: float
            ) -> Tuple[float, float]:
                """
            ...
            try:
                if right_entered:
                    new_right_sphere, new_right_cylinder = _calculate_vertex_power(
                    ...
                    """
                if left_entered:
                    new_left_sphere, new_left_cylinder = _calculate_vertex_power(
                        left_sphere, left_cylinder
                    )
                    left_answer = f"""
